...
import { Shield, ArrowRight, Lock, Mail, Eye, EyeOff, CheckCircle2 } from 'lucide-react';
import { Link } from 'react-router-dom';

// Social button icons as inline SVGs for accuracy
const GoogleIcon = () => (
    ...
    <div className="min-h-screen bg-[#030305] text-white font-sans flex overflow-hidden relative">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[52%] relative overflow-hidden bg-[#070710] border-r border-white/5 p-12">
        ...
        <Link to="/" className="relative z-10 inline-flex items-center gap-2.5 w-fit">
          ...
          <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">Sentry</span>
        </Link>
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center py-16">
          ...
          <p className="text-gray-400 text-base leading-relaxed max-w-sm mb-10">
            Sentry's AI swarm monitors, investigates, and remediates threats before they become incidents.
          </p>
        ...
        <div className="relative z-10 border border-white/8 rounded-2xl bg-white/[0.03] backdrop-blur-sm p-5">
          <p className="text-sm text-gray-300 leading-relaxed italic mb-4">
            "Sentry cut our mean time to remediation from 6 hours to under 4 seconds. It's like having a thousand security engineers on call."
          </p>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative">
        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-400">Sign in to your Sentry account to continue.</p>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 text-white text-sm font-medium transition-all duration-200 group"
            >
              <GoogleIcon />
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="group relative w-full mt-2 flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm text-black overflow-hidden transition-all duration-200 hover:scale-[1.01] hover:shadow-[0_0_30px_-8px_rgba(34,211,238,0.5)] active:scale-[0.99]"
              style={{
