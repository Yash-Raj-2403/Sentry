        ...
        <div className="max-w-7xl mx-auto w-full h-full flex flex-col lg:flex-row items-center justify-between px-6 relative z-10 pointer-events-none">
          <div className="flex-1 max-w-xl pt-32 lg:pt-0 pointer-events-auto opacity-0 animate-fade-in-up" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
            ...
            <p className="text-lg text-gray-400 mb-10 leading-relaxed max-w-lg font-medium">
              Stop chasing alerts. Sentry's AI swarm investigates, patches, and deploys fixes before threats can exploit them.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Replace manual playbooks with intelligent agents. Sentry monitors every layer of your stack.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <FeatureCard 
              ...
              desc="Sentry doesn't just block attacks; it identifies the vulnerability and suggests code fixes."
      ...
      <section className="py-32 px-6">
        <div className="max-w-4xl mx-auto text-center relative">
            ...
            <p className="text-xl text-gray-400 mb-12 max-w-xl mx-auto">
              Join the future of DevSecOps. Deploy Sentry today and let the agents handle the rest.
            </p>
